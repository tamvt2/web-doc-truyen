                            ...
                            <form class="user" method="post" action="{{ url('admin/chapter/add') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user"
                                        name="title"
                                        placeholder="Nhập tên của chương">
                                </div>
                                <div class="form-group">
                                    <label for="name" class="form-label ml-3">Nội dung của chương</label>
                                    <textarea class="form-control" name="content" placeholder="Nhập nội dung của chương" rows="10"></textarea>
                                </div>
                                <div class="form-group">
